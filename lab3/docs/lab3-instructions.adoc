...
<dependency>
	...
	<artifactId>spring-boot-starter-web</artifactId> <!-- 1 bootstrapping Tomcat -->
</dependency>

<dependency>
	<groupId>org.apache.tomcat.embed</groupId>
	<artifactId>tomcat-embed-jasper</artifactId>  <!-- 2 to compile JSP's -->
	<scope>provided</scope> <!-- 4 - only required during the packaging and not for runtime -->
</dependency>

<dependency>
	<groupId>javax.servlet</groupId>
	<artifactId>jstl</artifactId> <!-- 3 to enable JSP Standard Tag Library (JSTL) -->
	<scope>provided</scope> <!-- 4 - only required during the packaging and not for runtime -->
</dependency>
----
...
<3> We are also going to use JSP Standard Tag Library (JSTL) so we need add a dependencies for that.
...
1. Open a web browser and open http://localhost:8080/admin/productlist verify that the prodcut list page show our products form the database
...
1. add an additional method called `showProductForm` with different arguments like this:
+
[source,java]
----
